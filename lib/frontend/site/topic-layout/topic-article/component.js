...
class TopicArticle extends Component {
  ...
  render () {
    ...
    return (
      <div className={`topic-article-wrapper container`}>
        ...
        <div>
          <button className="btn btn-primary btn-special mr-3" onClick={() => this.scrollTo('the-action')}>Votá esta propuesta</button>
          <button className="btn btn-primary btn-special-two" onClick={() => this.scrollTo('the-comments')}>Comentá y debatí</button>
        </div>
        <div className="my-4 text-justify" style={{whiteSpace: 'pre-line'}}>
