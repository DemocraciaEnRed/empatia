    ...
    return (
      ...
      <footer className='ext-footer'>
        ...
        <div className='footer container'>
          <p className="promo">Hecho por <a href="https://democraciaenred.org" target="_blank">Democracia En Red</a></p>
          <p className="tyc">Ver <a href="https://drive.google.com/file/d/1daTb_V-eNafUnB_kZJBgtVF3EH0R50l6/view" target="_blank">Términos y Condiciones</a></p>
