    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='container forums-list my-5 py-5' id='consultas'>
          ...
          <p className="text-center mx-5 mb-5">Te acercamos los proyectos legislativos que estamos llevando adelante a nivel municipal, provincial y nacional. En cada uno de ellos podrás votar y mostrar tu apoyo o sumar tus aportes en los comentarios.</p>
          <p className="text-center mx-5 mb-5">Ayudanos a difundir en redes sociales para que la voz de la EMPATÍA sea cada vez más fuerte.</p>
