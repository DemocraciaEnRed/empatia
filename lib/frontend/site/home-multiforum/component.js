    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='container forums-list my-5 py-5' id='consultas'>
          ...
          <p className="text-center mx-5 mb-5">Te acercamos los proyectos que estamos llevando a la legislatura. En cada proyecto podes participar votando y comentando que opinas de cada uno de ellos</p>
