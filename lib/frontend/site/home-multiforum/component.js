    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='container forums-list my-5 py-5' id='consultas'>
          ...
          <p className="text-center mx-5 mb-5">Te acercamos los proyectos que estamos llevando adelante. En cada uno de ellos podrás votar y mostrar tu apoyo o sumar tus aportes en los comentarios. </p>
