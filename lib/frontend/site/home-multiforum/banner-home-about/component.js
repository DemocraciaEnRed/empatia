    ...
    return (
      <div id='banner-home-auto'>
        <div className='about-content'>
          ...
          Es un espacio para que puedas compartir una propuesta que mejore el país, tu provincia o tu ciudad. Además, vas a poder comentar los proyectos que estamos presentando desde la Cámara de Diputados.
          </p>
          <div>
        ...
        <div className="picture-right" style={{ backgroundImage: "url('/lib/frontend/site/home-multiforum/picture-section-home.jpg')" }} />
