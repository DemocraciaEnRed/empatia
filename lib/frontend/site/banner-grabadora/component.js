    ...
    let blockedMicrophone = () => {
      return (
        <div className='text-center'>
          <p>
            <i className="fas fa-microphone-lines-slash fa-3x"></i>
          </p>
        ...
        <button className="btn btn-warning" onClick={this.resetRecording} disabled={!this.state.isRecordingStp}>Reset</button> */}
          ...
          { step6 && (
              <div>
                ...
                <button className='btn btn-primary mt-3' disabled={!about || !scale} onClick={this.submitMetadata}>Enviar <i className="fas fa-paper-plane"></i></button>
              </div>
            )
          }
          { step7 && (
