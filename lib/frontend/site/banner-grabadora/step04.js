...
class Step04 extends Component {
  ...
  render () {
    ...
    return (
      <div>
        <div className="step-title-container my-3">¡ULTIMO PASO!</div>
          <p className='subtitle'>Contanos mas acerca de la propuesta y dejanos tus datos de contacto para que...</p>
          <div className='row'>
        ...
        <div className='row'>
          <div className='col-md-8 offset-md-2'>
            <div className='form-group text-left'>
              <label htmlFor='contact' className='is-size-6'><b>¿Quién pensas que tiene que ejecutar tu propuesta?</b></label>
            ...
            </div>
            {
              this.state.scale === 'Otro' ?
                <div className='form-group text-left'>
                  <label htmlFor='contact' className='is-size-6'><b>Escriba aquí quien cree que deberia ejecutarla</b></label>
            ...
            <div className='form-group text-left'>
              <label htmlFor='contact' className='is-size-6'><b>Acá tenés un espacio para contarnos un poco más por que pensas que es necesaria tu propuesta</b></label>
