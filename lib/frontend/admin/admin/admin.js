...
import AdminAudios from '../admin-audios/component'
import AdminUsuarios from '../admin-usuarios/component'
...
page(urlBuilder.for('admin.audios'), (ctx) => {
  ctx.sidebar.set('audios')
  render(<AdminAudios forum={ctx.forum} />, document.querySelector('.admin-content'))
})

page(urlBuilder.for('admin.usuarios'), (ctx) => {
  ctx.sidebar.set('usuarios')
  render(<AdminUsuarios forum={ctx.forum} />, document.querySelector('.admin-content'))
})
