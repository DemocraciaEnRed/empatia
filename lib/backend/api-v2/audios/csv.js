...
app.get('/audio/all/csv',
  ...
  function sendCsv (req, res, next) {
    ...
    var data = [['ID', 'Grupo', 'Subgrupo', 'Resuelto', 'Destacado', 'URL Audio', 'Peso Audio', 'Fecha Subido', 'Registrado?', 'Nombre completo', 'Telefono', 'Email', 'Provincia', 'Localidad', 'Escala', 'Acerca de']]
