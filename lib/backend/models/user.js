...
const UserSchema = new Schema({
  ...
  dni: { type: String, maxlength: 50 },
  localidad: { type: String, maxlength: 200 },
  provincia: { type: String, maxlength: 200 },
...
UserSchema.virtual('manager').get(function () {
  const manager = config.manager || []
  return manager.includes(this.email)
})
