...
/**
 * Create password set Token for a user
 *
 * @param {Object} user object for which the
 * password reset Token is created.
 * @param {Function} fn callback function
...
exports.createPasswordSetToken = function createPasswordResetToken (user, meta, fn) {
  log('Creating new password set token for user %j', user)
  return createToken(user, meta, 'password-set', fn)
}
